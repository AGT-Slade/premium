...
function PlaceOrderScreen() {
    ...
    return <div>
                ...
                {/* </div><div className="container small-container"> */}
                <Helmet>
                            ...
                            <Card.Body>
                                ...
                                <ListGroup variant="flush">
                                    <ListGroup.Item>
                                        <Row>
                                            <Col>Items</Col>
                                            <Col className="text-end">${cart.itemsPrice.toFixed(2)}</Col>
                                        </Row>
                                    </ListGroup.Item>
                                    <ListGroup.Item>
                                        <Row>
                                    ...
                                    <ListGroup.Item>
                                        <Row>
                                            <Col>Tax</Col>
                                            <Col className="text-end">${cart.taxPrice.toFixed(2)}</Col>
                                        </Row>
                                    </ListGroup.Item>
                                    <ListGroup.Item>
                                        <Row>
                                            <Col>Order Total</Col>
                                            <Col className="text-end">${cart.totalPrice.toFixed(2)}</Col>
                                        </Row>
                                    </ListGroup.Item>
                                    <ListGroup.Item>
